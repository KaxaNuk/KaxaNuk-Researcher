...
> each file the process expects in the folders describes what belongs in it, and the worked
> example fills them in as far as its work has reached. Replace this banner with your own status
> when you take the repository over; it is the same line as your `README.md`'s.
