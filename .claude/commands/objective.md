...
Walk `Library/INDEX.md` and the links for the domains the strategy touches. Read the owner's `Notes/`
on how they invest. Where the library or a note says something the strategy's Bibliotheca does not,
