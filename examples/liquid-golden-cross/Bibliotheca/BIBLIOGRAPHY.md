...
| Daniel & Moskowitz (2013) — *Momentum Crashes* | claim 5, the state Experiment 4 conditions on: all fifteen of momentum's worst months came after a negative two-year market return, when past winners are low-beta and past losers rally; the crashes are in the short leg, and no risk explanation the paper tests accounts for them. Its dynamic weighting is in sample and before costs. Carried from Luna's library for claim 5: [note](Papers/Daniel_Moskowitz_2013_Momentum_Crashes.md) |
