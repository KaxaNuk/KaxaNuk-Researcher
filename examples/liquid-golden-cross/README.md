...
> blueprint asked for 0.03, so it **fails its kill switch** too. Every number is in
> [`RESULTS.md`](RESULTS.md). **One book is on paper, Experiment 4's, as a candidate the owner chose
> to track without graduation, from 2026-09-25**; nothing else here is out of sample, and each
> experiment was run or reproduced from a wiped working copy.
