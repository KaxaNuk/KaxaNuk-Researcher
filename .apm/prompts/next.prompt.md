...
| --- | --- | --- |
| 0 | the working tree is clean: `git status --short` prints nothing | commit what is there, with a message saying what came in |
