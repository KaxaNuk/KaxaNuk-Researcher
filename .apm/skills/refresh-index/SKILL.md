...
1. Scan every `.md` under `Knowledge/` except `INDEX.md` and `LOG.md`. Group by domain folder.
...
5. Write `INDEX.md`, and append to `Knowledge/LOG.md`: `## [YYYY-MM-DD] refresh-index | <N> articles
   indexed`.

Never modify an article during a refresh. Never index anything under `Philosophy/` or `Sources/`.
