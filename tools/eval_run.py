...
# Not `fixture`: beside the case's FIXTURE file the two names differ only by case, which Windows
# cannot tell apart, and the runner would refuse every fixture case as one it wrote itself.
FIXTURE_FOLDER = 'fixture-files'
